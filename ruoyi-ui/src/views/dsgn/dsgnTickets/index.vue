    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['dsgn:dsgnTickets:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['dsgn:dsgnTickets:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['dsgn:dsgnTickets:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['dsgn:dsgnTickets:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="dsgnTicketsList" @selection-change="handleSelectionChange">
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listDsgnTickets(this.queryParams).then(response => {
        this.dsgnTicketsList = response.rows;
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('dsgn/dsgnTickets/export', {
        ...this.queryParams
      }, `dsgnTickets_${new Date().getTime()}.xlsx`)
    }
  }
};
</script>
