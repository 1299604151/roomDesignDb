    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['dsgn:dsgnColors:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['dsgn:dsgnColors:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['dsgn:dsgnColors:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['dsgn:dsgnColors:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="dsgnColorsList" @selection-change="handleSelectionChange">
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listDsgnColors(this.queryParams).then(response => {
        this.dsgnColorsList = response.rows;
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('dsgn/dsgnColors/export', {
        ...this.queryParams
      }, `dsgnColors_${new Date().getTime()}.xlsx`)
    }
  }
};
</script>
