...
public class DsgnDesignSchemesController extends BaseController
{
     ...
     * 查询设计方案列表
     */
    @PreAuthorize("@ss.hasPermi('system:schemes:list')")
    @GetMapping("/list")
     ...
     * 导出设计方案列表
     */
    @PreAuthorize("@ss.hasPermi('system:schemes:export')")
     ...
     * 获取设计方案详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:schemes:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增设计方案
     */
    @PreAuthorize("@ss.hasPermi('system:schemes:add')")
     ...
     * 修改设计方案
     */
    @PreAuthorize("@ss.hasPermi('system:schemes:edit')")
     ...
     * 删除设计方案
     */
    @PreAuthorize("@ss.hasPermi('system:schemes:remove')")
