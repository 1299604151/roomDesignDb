...
import com.ruoyi.system.domain.DsgnStyles;
import com.ruoyi.system.service.IDsgnStylesService;
...
public class DsgnStylesController extends BaseController
{
     ...
     * 查询风格列表
     */
    @PreAuthorize("@ss.hasPermi('system:styles:list')")
    @GetMapping("/list")
     ...
     * 导出风格列表
     */
    @PreAuthorize("@ss.hasPermi('system:styles:export')")
     ...
     * 获取风格详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:styles:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增风格
     */
    @PreAuthorize("@ss.hasPermi('system:styles:add')")
     ...
     * 修改风格
     */
    @PreAuthorize("@ss.hasPermi('system:styles:edit')")
     ...
     * 删除风格
     */
    @PreAuthorize("@ss.hasPermi('system:styles:remove')")
