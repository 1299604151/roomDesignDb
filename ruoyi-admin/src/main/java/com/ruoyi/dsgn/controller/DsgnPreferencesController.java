 ...
 */
@RestController
@RequestMapping("/dsgn/dsgnPreferences")
public class DsgnPreferencesController extends BaseController
{
     ...
     * 查询用户偏好列表
     */
    @PreAuthorize("@ss.hasPermi('dsgn:dsgnPreferences:list')")
    @GetMapping("/list")
     ...
     * 导出用户偏好列表
     */
    @PreAuthorize("@ss.hasPermi('dsgn:dsgnPreferences:export')")
     ...
     * 获取用户偏好详细信息
     */
    @PreAuthorize("@ss.hasPermi('dsgn:dsgnPreferences:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增用户偏好
     */
    @PreAuthorize("@ss.hasPermi('dsgn:dsgnPreferences:add')")
     ...
     * 修改用户偏好
     */
    @PreAuthorize("@ss.hasPermi('dsgn:dsgnPreferences:edit')")
     ...
     * 删除用户偏好
     */
    @PreAuthorize("@ss.hasPermi('dsgn:dsgnPreferences:remove')")
