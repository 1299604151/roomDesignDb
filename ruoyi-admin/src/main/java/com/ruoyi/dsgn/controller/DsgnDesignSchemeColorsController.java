 ...
 */
@RestController
@RequestMapping("/dsgn/dsgnDesignSchemeColors")
public class DsgnDesignSchemeColorsController extends BaseController
{
     ...
     * 查询设计方案-色彩关联列表
     */
    @PreAuthorize("@ss.hasPermi('dsgn:dsgnDesignSchemeColors:list')")
    @GetMapping("/list")
     ...
     * 导出设计方案-色彩关联列表
     */
    @PreAuthorize("@ss.hasPermi('dsgn:dsgnDesignSchemeColors:export')")
     ...
     * 获取设计方案-色彩关联详细信息
     */
    @PreAuthorize("@ss.hasPermi('dsgn:dsgnDesignSchemeColors:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增设计方案-色彩关联
     */
    @PreAuthorize("@ss.hasPermi('dsgn:dsgnDesignSchemeColors:add')")
     ...
     * 修改设计方案-色彩关联
     */
    @PreAuthorize("@ss.hasPermi('dsgn:dsgnDesignSchemeColors:edit')")
     ...
     * 删除设计方案-色彩关联
     */
    @PreAuthorize("@ss.hasPermi('dsgn:dsgnDesignSchemeColors:remove')")
