...
import com.ruoyi.dsgn.mapper.DsgnDesignSchemeMaterialsMapper;
 ...
 */
@Service
public class DsgnDesignSchemeMaterialsServiceImpl implements IDsgnDesignSchemeMaterialsService 
{
    @Autowired
